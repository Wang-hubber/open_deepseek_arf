...
- [设计理念](#设计理念大脑-脊椎-身体模型) → [三层机械层](#三层机械层) → [第二部分 — 研究路线图](#第二部分--研究路线图) → [演进方向](#演进方向)

**框架使用者** — 想基于 ARF 构建应用：

- [6 骨架架构](#harness-即内核6-骨架架构) → [Plugin 体系](#plugin-体系反射弧非认知模块) → 然后移步 [ARF App 教学项目](https://gitee.com/dalaydata/arf_app_021)，7 单元渐进式教程，从零到生产级 Agent
