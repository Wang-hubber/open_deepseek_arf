...
> 统计：OPEN 8 / FIXED 0 / WONTFIX 0（截至 task 9.3.2 探查：A 类别 2 病灶 [A3/A4] 9.2.2 真实 payload 复测通过；F 类别 6 病灶 [F-001 EnginePool / F-002 pool 动态扩容 critical / F-003 facade sub_id quirk / F-004 缺 stream event callback API / F-005 缺 thinking 传播 / F-006 spec/code naming 不一致]——F-002 critical design intent gap，F-003 development-stage design quirk，F-005 framework 缺 Engine 传播链路，F-006 spec/code 命名误导）
