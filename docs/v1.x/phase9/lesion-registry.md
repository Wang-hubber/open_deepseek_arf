...
> 统计：OPEN 6 / FIXED 0 / WONTFIX 0（截至 task 9.3.1 探查：A 类别 2 病灶 [A3/A4] 9.2.2 真实 payload 复测通过；F 类别 4 病灶 [F-001 EnginePool / F-002 pool 动态扩容 critical / F-003 facade sub_id quirk / F-004 缺 stream event callback API]——F-002 critical design intent gap，F-003 development-stage design quirk，F-004 缺 app 暴露 streaming API hook）
