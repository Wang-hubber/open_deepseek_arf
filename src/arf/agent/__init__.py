...
class ARFAgent:
    ...
    def _identity_section(self) -> str:
        ...
        return (
            ...
            "## Model Switching\n\n"
            "The session starts with `quick_no_thinking` (fast, no reasoning). "
            "When tasks become more complex, use `model_switch` to choose the "
            "appropriate level. Read `@sys/skills/model_switch/skill.yaml` for "
            ...
            "- **simple** (greetings, file reads, factual Q&A) -> quick_no_thinking\n"
            "- **medium** (code, debugging, tool orchestration) -> quick_thinking\n"
